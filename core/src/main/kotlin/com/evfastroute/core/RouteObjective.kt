...
enum class RouteObjective {
    ...
    val explanation: String
        get() = when (this) {
            ...
            RELIABLE ->
                "Prioritizes stations with stronger availability and reliability signals."
            LOWEST_COST ->
            ...
            VERIFIED ->
                "A conservative fallback whose complete road sequence was verified by Apple Maps."
        }
